    ...
    <div className="pt-16 pb-24">
      ...
      <div className="flex justify-between w-full gap-8 p-8 overflow-x-auto hide-scrollbar max-sm:gap-4 max-sm:p-4">
        <Link
          ...
          className="flex flex-col justify-between gap-4 min-w-96 bg-base-100 shadow-xl p-4 rounded-md  max-md:min-w-72 max-sm:min-w-60"
        >
      ...
      <div className="flex justify-between w-full gap-8 p-8 overflow-x-auto hide-scrollbar max-sm:gap-4 max-sm:p-4">
        ...
        >
          ...
          <div className="card-actions justify-end">
            <p to={'products?category=Mobile'} className="text-[#007185]">
              See more.
            </p>
          </div>
        </Link>
